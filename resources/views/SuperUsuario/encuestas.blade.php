...
<body>
    ...
    <nav class="nav divportada ">
        ...
        <ul class="nav nav-pills nav-justified">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('Consultas',['id'=>$IDUsuario]) }}">Consulta</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('Encuestas',['id'=>$IDUsuario]) }}" disabled>Encuestas</a>
            </li>
            <li class="nav-item">
    ...
    <div class="fondotexto">
        ...
        <p class="textform">¿Que subirá la gente? </p>
        <br>
        ...
        new Chart(ctx, {
            type: 'bar',
            data: {
            labels: ['Video', 'Audio', 'Documentos', 'Imagenes'],
            datasets: [{
                label: 'Cantidad de votos',
                data: [{{ $vid }}, {{ $aud }}, {{ $doc }}, {{ $img }}],
                borderWidth: 1
            }]
            },
            options: {
