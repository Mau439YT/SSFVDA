...
<body>
    ...
    <nav class="nav divportada ">
        ...
        <ul class="nav nav-pills nav-justified">
            ...
            <li class="nav-item">
                <a class="nav-link active" value="Editar" id="Editar" href="{{ route('Selfmodif',['id'=>$id]) }}" disabled>Editar usuario</a>
            </li>
            <li class="nav-item">
    ...
    <div class="formulario">
        ...
        <br><br>
        <form action="{{ route('Selfmoddata',['id'=>$id]) }}" method="POST">
            @csrf
        <label class="textform">Usuario: </label>
        <input class="form-control form-control-lg" type="text" id="usuario" name="usuario" placeholder="John Doe" value="{{$NameUser}}" required>
        <br><br>
        <label class="textform">Email: </label>
        <input class="form-control form-control-lg" type="text" id="email" name="email" placeholder="John Doe" value="{{$Email}}" required>
        <br><br>
        <label class="textform">Edad: </label>
        <input class="form-control form-control-lg" type="number" id="edad" name="edad" placeholder="ej. 20" value="{{ $Edad }}" style="width: 70px; display: inline" required>
        <br><br><br>
        ...
        <label class="textform" name="sx">Sexo: </label><br>
         ...
         <br><br>
        <label class="textform" >Confirma tu contraseña: </label>
